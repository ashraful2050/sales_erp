...
<div class="wrapper">
  ...
  <div class="body">
    ...
    <div class="field">
      ...
      <div class="value"><a href="mailto:<?php echo e($contact->email); ?>"><?php echo e($contact->email); ?></a></div>
    </div>
    ...
    <div class="field">
      ...
      <div class="value"><?php echo e($contact->company_name); ?></div>
    </div>
    <?php if($contact->company_size): ?>
    <div class="field">
      <div class="label">Company Size</div>
      <div class="value"><?php echo e($contact->company_size); ?> employees</div>
    </div>
    <?php endif; ?>
    <?php if($contact->industry): ?>
    <div class="field">
      <div class="label">Industry</div>
      <div class="value"><?php echo e($contact->industry); ?></div>
    </div>
    <?php endif; ?>
    <?php if($contact->plan_interest): ?>
    <div class="field">
      <div class="label">Plan Interest</div>
      <div class="value"><span class="badge"><?php echo e($contact->plan_interest); ?></span></div>
    </div>
    <?php endif; ?>
    <?php if($contact->message): ?>
    <div class="field">
      <div class="label">Message</div>
      <div class="value" style="white-space: pre-wrap;"><?php echo e($contact->message); ?></div>
    </div>
    <?php endif; ?>
    <div class="field">
      <div class="label">Submitted At</div>
      <div class="value"><?php echo e($contact->created_at->format('d M Y, h:i A')); ?></div>
    </div>
    <div class="field">
    ...
    <a href="<?php echo e($reviewUrl); ?>" class="btn">Review Request →</a>
  </div>
  <div class="footer">
...
<?php /**PATH D:\xampp\htdocs\sales_erp\resources\views/emails/contact-request-received.blade.php ENDPATH**/ ?>