...
export default function BankAccountForm({ bankAccount, glAccounts }) {
    ...
    return (
        <AppLayout
            title={isEdit ? t("Edit Bank Account") : t("Add Bank Account")}
        >
            <Head
                title={isEdit ? t("Edit Bank Account") : t("Add Bank Account")}
            />
            <PageHeader
                ...
                subtitle={
                    isEdit
                        ? `${t("Editing")}: ${bankAccount.bank_name}`
                        : t("Link a new bank account")
                }
                actions={
                    <Link
            ...
            <form onSubmit={submit} className="max-w-3xl space-y-6">
                <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Field label={t("Branch")} error={errors.branch_name}>
                            <Input
                        ...
                        <Field
                            label={t("GL Account (Chart of Accounts)")}
