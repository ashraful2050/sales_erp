                    ...
                    <dl className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <dd>
                                <Badge
                                    color={
                                        bankAccount.is_active ? "green" : "red"
                                    }
                                >
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50 text-xs text-gray-500 uppercase">
                                <tr>
                                    {[
                                        ...
                                        <th
                                            key={h}
                                            className={`px-4 py-3 ${h === "Amount" || h === "Balance" ? "text-right" : "text-left"}`}
                                        >
                                            {h}
                                        </th>
                                    ))}
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {bankAccount.transactions?.length ? (
                                    bankAccount.transactions.map((txn) => (
                                        <tr
                                            key={txn.id}
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <span
                                                    className={`inline-flex items-center gap-1 text-xs font-medium ${txn.type === "credit" ? "text-green-700" : "text-red-700"}`}
                                                >
                                                    {txn.type === "credit" ? (
                                            ...
                                            <td
                                                className={`px-4 py-3 text-right font-medium ${txn.type === "credit" ? "text-green-700" : "text-red-700"}`}
                                            >
                                                {txn.type === "credit"
                                                    ? "+"
                                                    : "-"}
