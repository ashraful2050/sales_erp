...
export default function Show({ period }) {
    ...
    const totalGross =
        period.records?.reduce((s, r) => s + Number(r.gross_salary ?? 0), 0) ??
        0;
    ...
    const totalNet =
        period.records?.reduce((s, r) => s + Number(r.net_salary ?? 0), 0) ?? 0;
