...
export default function EmployeeForm({ employee, departments, designations }) {
    ...
    return (
        <AppLayout title={isEdit ? t("Edit Employee") : t("New Employee")}>
            <Head title={isEdit ? t("Edit Employee") : t("New Employee")} />
            <PageHeader
                title={isEdit ? t("Edit Employee") : t("New Employee")}
                subtitle={
                    isEdit
                        ? `${t("Editing")}: ${employee.name}`
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            <Select
                                ...
                                onChange={(e) =>
                                    setData("salary_type", e.target.value)
                                }
                            >
