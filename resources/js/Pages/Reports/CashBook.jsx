...
export default function CashBook({ accounts, transactions, filters, totals }) {
    ...
    return (
        <AppLayout title={t("Cash Book")}>
            ...
            <PageHeader
                title={t("Cash Book")}
                subtitle={t("Bank account transaction history")}
            />
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white rounded-xl border border-slate-200 p-4 text-center">
                            ...
                            <p className="text-xl font-bold text-slate-700">
                                {fmt(
                                    parseFloat(totals.opening_balance ?? 0) +
                                        parseFloat(totals.total_debit ?? 0) -
                                        parseFloat(totals.total_credit ?? 0),
                                )}
                            </p>
                        </div>
                    </div>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {!accountId && (
                                    <tr>
                                        ...
                                        >
                                            Select a bank account to view the
                                            cash book.
                                        </td>
                                    </tr>
                                )}
                                ...
                                {accountId && totals && (
                                    <tr className="bg-blue-50">
                                        <td
                                            colSpan={5}
                                            className="px-6 py-2 text-slate-600 font-medium italic"
                                        >
                                            Opening Balance
                                        </td>
                                        <td className="px-6 py-2 text-right font-semibold text-blue-700">
                                            {fmt(totals.opening_balance)}
                                        </td>
                                        <td></td>
                                    </tr>
