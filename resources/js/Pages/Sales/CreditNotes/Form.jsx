...
export default function CreditNoteForm({
    ...
    const selectProduct = (idx, productId) => {
        ...
        if (p) {
            ...
            items[idx].tax_amount =
                base * (Number(items[idx].tax_rate || 0) / 100);
    ...
    const subtotal = data.items.reduce(
        (s, i) => s + Number(i.total || 0) - Number(i.tax_amount || 0),
        0,
    );
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="text-left px-4 py-3 text-xs font-semibold text-slate-500 uppercase w-48">
                                        {t("Product")}
                                    </th>
                                    <th className="text-left px-4 py-3 text-xs font-semibold text-slate-500 uppercase">
                                        {t("Description")}
                                    </th>
                                    <th className="text-right px-4 py-3 text-xs font-semibold text-slate-500 uppercase w-20">
                                        {t("Qty")}
                                    </th>
                                    <th className="text-right px-4 py-3 text-xs font-semibold text-slate-500 uppercase w-28">
                                        {t("Unit Price")}
                                    </th>
                                    <th className="text-right px-4 py-3 text-xs font-semibold text-slate-500 uppercase w-20">
                                        {t("Tax %")}
                                    ...
                                    <tr key={i} className="hover:bg-slate-50">
                                        ...
                                        <td className="px-3 py-2">
                                            <input
                                                ...
                                                className="border border-slate-200 rounded-lg px-2 py-1.5 text-xs text-right w-full"
                                                min="0.0001"
                                                step="0.0001"
                                            />
                                        </td>
                            ...
                            <tfoot className="bg-slate-50 border-t-2 border-slate-200">
                                <tr>
                                    <td
                                        colSpan={5}
                                        className="px-4 py-2 text-right text-sm font-medium text-slate-600"
                                    >
                                        {t("Subtotal")}:
                                    </td>
