...
export default function CustomerForm({ customer }) {
    ...
    return (
        <AppLayout title={isEdit ? t("Edit Customer") : t("New Customer")}>
            <Head title={isEdit ? t("Edit Customer") : t("New Customer")} />
            <PageHeader
                title={isEdit ? t("Edit Customer") : t("New Customer")}
                subtitle={
                    isEdit
                        ? `${t("Editing")}: ${customer.name}`
                        : t("Add a new customer to your system")
                }
                actions={
                    <Link
            ...
            <form onSubmit={submit} className="max-w-4xl space-y-6">
                ...
                <div className="flex justify-end gap-3 pb-8">
                    ...
                    >
                        <Save size={16} />{" "}
                        {isEdit ? t("Update Customer") : t("Create Customer")}
                    </button>
                </div>
            </form>
        </AppLayout>
