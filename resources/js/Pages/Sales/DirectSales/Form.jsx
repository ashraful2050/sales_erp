...
export default function DirectSaleForm({
    ...
    const selectTaxRate = (idx, taxRateId) => {
        ...
        updateLine(idx, "tax_rate_id", taxRateId);
        updateLine(idx, "tax_rate", tax?.rate ?? 0);
    };
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("sales.direct-sales.store"));
    };

    return (
        <AppLayout title="New Direct Sale">
            <Head title="New Direct Sale" />
            <PageHeader
                title="New Direct Sale"
                subtitle="Immediate cash/card sale — invoice + payment recorded at once"
                actions={
                    <Link
                                    ...
                                    <tr key={idx}>
                                        ...
                                        <td className="px-3 py-2">
                                            <input
                                                ...
                                                className="w-full border border-slate-200 rounded-lg px-2 py-1.5 text-xs text-center focus:outline-none focus:ring-1 focus:ring-blue-400"
                                                placeholder="pcs"
                                            />
                                        </td>
                                        <td className="px-3 py-2">
                                            <input
                                                ...
                                                className="w-full border border-slate-200 rounded-lg px-2 py-1.5 text-xs text-right focus:outline-none focus:ring-1 focus:ring-blue-400"
                                            />
                                        </td>
                                        <td className="px-3 py-2">
                                            <input
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-3 text-sm">
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <input
                                ...
                                className="w-28 text-right border border-slate-200 rounded-lg px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                        </div>
