...
export default function QuotationForm({
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        invoice_date:
            quote?.invoice_date ?? new Date().toISOString().slice(0, 10),
    ...
    return (
        <AppLayout title={isEdit ? t("Edit Quotation") : t("New Quotation")}>
            <Head title={isEdit ? t("Edit Quotation") : t("New Quotation")} />
            <PageHeader
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="text-left px-4 py-3 text-xs font-semibold text-slate-500 uppercase w-44">
                                        {t("Product")}
                                    </th>
