...
export default function Form({ warehouse }) {
    ...
    return (
        <AppLayout title={isEdit ? t("Edit Warehouse") : t("New Warehouse")}>
            <Head title={isEdit ? t("Edit Warehouse") : t("New Warehouse")} />
            <div className="p-6 max-w-2xl mx-auto space-y-6">
                <PageHeader
                    title={isEdit ? t("Edit Warehouse") : t("New Warehouse")}
                    actions={
                        <Link
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={t("e.g. Main Warehouse")}
                            />
                            {errors.name && (
