                    ...
                    <div className="lg:col-span-2 space-y-5">
                            ...
                            <div className="px-8 pt-8 pb-6 border-b border-slate-100">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-2">
                                        {faq.category && (
                                            <span
                                                className={`flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full border ${catColor}`}
                                            >
                                                <span>{faq.category.icon}</span>{" "}
                                                {faq.category.name}
                                            </span>
                                        )}
                                    </div>
                                    <Link
                                        href={route("faq.admin.edit", faq.id)}
                        ...
                        <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6 text-center">
                            ...
                            <p className="text-xs text-slate-400 mb-4">
                                {total > 0
                                    ? `${faq.helpful_yes} of ${total} people found this helpful`
                            ...
                            <div className="flex justify-center gap-3">
                                ...
                                >
                                    ...
                                    <span className="bg-red-100 text-red-500 rounded-full px-2 py-0.5 text-xs">
                                        {faq.helpful_no}
                                    </span>
                                </button>
                            </div>
                    ...
                    <div className="space-y-4">
                                ...
                                <div className="divide-y divide-slate-50">
                                    {related.map((r) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-sm text-slate-700 group-hover:text-blue-600 leading-snug">
                                                {r.question}
                                            </p>
                                        </Link>
                                    ))}
                        ...
                        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5">
                            ...
                            <p className="text-xs text-blue-600 mb-3">
                                {t(
                                    "Browse all articles or contact your administrator",
                                )}
                            </p>
                            <Link
                                href={route("faq.index")}
