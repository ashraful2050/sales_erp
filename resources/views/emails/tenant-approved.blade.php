...
<div class="wrapper">
  ...
  <div class="body">
    <p>Hi {{ $contact->name }},</p>
    <p>Great news! Your request to join <strong>AccounTech BD</strong> has been approved. Your company account <strong>{{ $company->name }}</strong> has been created and is ready to use.</p>
    <hr class="divider">
    <p><strong>Your Login Credentials:</strong></p>
    <div class="creds">
      <div class="row">
        <span class="key">Login URL</span>
        <span class="val"><a href="{{ $loginUrl }}">{{ $loginUrl }}</a></span>
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <span class="val">{{ $tempPassword }}</span>
      </div>
      <div class="row">
  ...
  <div class="footer">
    AccounTech BD &mdash; Multi-tenant ERP Platform &bull; This email was sent to {{ $contact->email }}
  </div>
</div>
</body>
</html>
